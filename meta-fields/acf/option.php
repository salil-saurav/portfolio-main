            ...
            'fields' => array(
                ...
                array(
                    ...
                    'sub_fields' => array(
                        ...
                        array(
                            'key' => 'field_header_cta_btn_label',
                            'label' => 'CTA Button Label',
                            'name' => 'header_cta_btn_label',
                            'type' => 'text',
                        ),
                        array(
                ...
                array(
                    'key' => 'field_show_header_account_icon',
                    'label' => 'Show Account Icon',
                    'name' => 'show_header_account_icon',
                    'type' => 'true_false',
                    'ui' => 1, // Use toggle switch
                    'default_value' => 0, // Default to false
                ),
                ...
                array(
                    'key' => 'field_request_content_removal_thank_you_page_content',
                    'label' => 'Request Content Removal Thank You Content',
                    'name' => 'request_content_removal_thank_you_page_content',
                    'type' => 'text',
                ),
                array(
                ...
                array(
                    'key' => 'field_error_page_content',
                    'label' => 'Content',
                    'name' => 'error_page_content',
                    'type' => 'text',
                ),
                array(
                    'key' => 'field_error_page_cta_btn_label',
                    'label' => 'CTA Button Label',
                    'name' => 'error_page_cta_btn_label',
                    'type' => 'text', // Text input field
                ),
                ...
                array(
                    'key' => 'field_plans_popup_title',
                    'label' => 'Title',
                    'name' => 'plans_popup_title',
                    'type' => 'text',
                ),
                array(
                    'key' => 'field_plans_popup_sub_title',
                    'label' => 'Sub-Title',
                    'name' => 'plans_popup_sub_title',
                    'type' => 'text',
                ),
